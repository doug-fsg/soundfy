      ...
      <div class="wrapper">
        <article class="post">
          <header class="post-header">
            ...
            <b-button type="submit" variant="outline-primary" @click="mostra">
            <i class="fas fa-save"></i> MOSTRA TOAST
          </b-button>
...
export default {
  ...
  methods: {
    async mostra() {
    console.log("Método mostra chamado"); // Log para verificar se o método é chamado
    try {
      await this.showToast("success", "Sucesso!", "teste de mensagem");
      console.log("Toast exibido com sucesso"); // Log para verificar se o toast foi exibido
    } catch (error) {
      console.error("Erro ao exibir toast:", error); // Log para capturar qualquer erro
    }
  },
