...
ee.on("volumechange", function(volume, track) {
  displaySoundStatus(track.name + " agora tem volume " + volume + ".");
});
...
ee.on("cut", function() {
  displayLoadingData("Operação de corte foi iniciada.");
});

ee.on("cutfinished", function() {
  displayLoadingData("A operação de corte terminou.");
});


var audioStates = ["não inicializado", "carregando", "decodificando", "Finalizado"];
...
ee.on("audiorequeststatechange", function(state, src) {
  ...
  displayLoadingData("Faixa " + name + " está " + audioStates[state]);
});
...
ee.on("loadprogress", function(percent, src) {
  ...
  displayLoadingData("Faixa " + name + " carregando " + percent + "%");
});

ee.on("audiosourcesloaded", function() {
  displayLoadingData("Todas as faixas foram decodificadas.");
});

ee.on("audiosourcesrendered", function() {
  displayLoadingData("As trilhas foram renderizadas");
});
